...
function igthemes_add_customizer_css() {
    ...
    .header-nav.center {
        border-top:4px solid '. get_theme_mod('header_link_hover ', $header_link_hover  ) .';
        border-bottom: 1px solid '. igthemes_color_brightness( get_theme_mod('header_background_color', $header_background_color ), -20) .';
    ...
    .main-navigation ul ul {
       background: '. get_theme_mod('header_background_color', $header_background_color ) .';
       border-bottom: 2px solid '. get_theme_mod( 'header_link_hover', $header_link_hover ) .';
    }
    ...
    footer.entry-footer { 
        border-color: '. get_theme_mod('body_link_hover', $body_link_hover) .';
